...
unsigned char key[16] = {0x20, 0x85, 0x52, 0x29, 0xF8, 0xA1, 0x65, 0x74,
                         0x4B, 0xE1, 0x8A, 0xCF, 0x94, 0xC2, 0x9E, 0x8D};

unsigned char g_roundKeyTable[4 * Nb * (Nr + 1)];
...
static void SubBytes(unsigned char *pState, unsigned char nCount,
...
static void XorBytes(unsigned char *pData1, const unsigned char *pData2,
